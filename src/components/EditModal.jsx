...
const EditModal = ({ showModal, setShowModal, data }) => {
    let { id } = useParams()
    console.log(data)
        ...
        <>
            {showModal ? (
                <>
                    ...
                    <div className="fixed  lg:w-[40%]  h-[60%] m-auto left-0 right-0 top-0 bottom-0">
                        <div className="border-0 p-8 bg-gray-800 block rounded-lg shadow-lg  flex flex-col   ">
                            <div className="w-full flex items-start justify-between  border-b border-solid border-gray-300 rounded-t ">
                                <h3 className="text-3xl text-white font-semibold">Edit Post</h3>
                                <button
                            ...
                            <form className="mt-4 " onSubmit={handleSubmit}>
                                ...
                                <div className="flex justify-center items-center w-full my-5">
                                    <button type="submit" className="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Edit post</button>
                                </div>
                            </form>
